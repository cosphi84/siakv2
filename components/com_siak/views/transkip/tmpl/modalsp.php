...
$function = $app->input->getCmd('function', 'jSelectNilaisp');
$onclick = $this->escape($function);
?>

<div class="container-popup">
    <form
        action="<?php echo JRoute::_('index.php?option=com_siak&view=transkip&layout=modalsp&tmpl=component&function='.$function.'&'.JSession::getFormToken().'=1'); ?>"
        ...
        <table class="table table-striped" id="classesList">
            ...
            <tbody>
                ...
                <tr class="row<?php echo $i % 2; ?>">
                    ...
                    <td>
                        <?php $link = 'index.php?option=com_siak&view=transkip&id='.$item->id;
