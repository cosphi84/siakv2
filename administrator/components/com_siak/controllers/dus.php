...
class SiakControllerDus extends JControllerAdmin
{
    public function getModel($name = 'Du', $prefix = 'SiakModel', $config = [])
    {
    ...
    public function confirm()
    {
        ...
        $this->setRedirect('index.php?option=com_siak&view=dus');
    }
    ...
    {
        $this->checkToken();
        $this->setRedirect('index.php?option=com_siak&view=dus&format=xlsx');
    }
}
