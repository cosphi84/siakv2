...
class SiakControllerPaketmks extends JControllerAdmin
{
    public function getModel($name = 'Paketmk', $prefix = 'SiakModel', $config = [])
    {
    ...
    public function delete()
    {
        ...
        $this->setRedirect('index.php?option=com_siak&view=paketmks');
    }

    public function excel()
    {
        $this->checkToken();
        $this->setRedirect('index.php?option=com_siak&view=paketmks&format=xlsx');
    }
}
