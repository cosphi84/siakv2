...
class SiakControllerKps extends JControllerForm
{
    ...
    {
        $this->checkToken();
        $this->setRedirect('index.php?option=com_siak&view=kps&format=xlsx');
    }
    ...
    public function delete()
    {
        ...
        $this->setRedirect('index.php?option=com_siak&view=kps');
    }
}
