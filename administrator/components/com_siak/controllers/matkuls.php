...
class SiakControllerMatkuls extends JControllerAdmin
{
    public function getModel($name = 'Matkul', $prefix = 'SiakModel', $config = [])
    {
    ...
    public function delete()
    {
        ...
        $this->setRedirect('index.php?option=com_siak&view=matkuls');
    }

    public function excel()
    {
        $this->checkToken();
        $this->setRedirect('index.php?option=com_siak&view=matkuls&format=xlsx');
    }
}
