...
class SiakControllerJurusans extends JControllerAdmin
{
    public function getModel($name = 'Jurusan', $prefix = 'SiakModel', $config = [])
    {
    ...
    public function delete()
    {
        ...
        $this->setRedirect('index.php?option=com_siak&view=jurusans');
    }
}
