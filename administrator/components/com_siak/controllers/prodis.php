...
class SiakControllerProdis extends JControllerAdmin
{
    public function getModel($name = 'Prodi', $prefix = 'SiakModel', $config = [])
    {
    ...
    public function delete()
    {
        ...
        $this->setRedirect('index.php?option=com_siak&view=prodis');
    }
}
