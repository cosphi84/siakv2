...
class SiakControllerSemesters extends JControllerAdmin
{
    public function getModel($name = 'Semester', $prefix = 'SiakModel', $config = [])
    {
    ...
    public function delete()
    {
        ...
        $this->setRedirect('index.php?option=com_siak&view=semesters');
    }
}
