...
class SiakControllerWalis extends JControllerAdmin
{
    public function getModel($name = 'Wali', $prefix = 'SiakModel', $config = [])
    {
    ...
    public function delete()
    {
        ...
        $this->setRedirect('index.php?option=com_siak&view=walis');
    }
}
