...
class SiakControllerSps extends JControllerAdmin
{
    public function getModel($name = 'Sp', $prefix = 'SiakModel', $config = [])
    {
    ...
    public function delete()
    {
        ...
        $this->setRedirect('index.php?option=com_siak&view=sps');
    }
}
