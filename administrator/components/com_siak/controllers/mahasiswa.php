...
class SiakControllerMahasiswa extends JControllerForm
{
    protected $text_prefix = 'COM_SIAK_MAHASISWA';
    protected $view_list = 'mahasiswas';
    ...
    public function edit($key = null, $urlVar = null)
    {
        ...
        $recordId = (int) $model->getRecordID($cid[0]);

        \JFactory::getApplication()->setUserState($context.'.userID', $cid[0]);
