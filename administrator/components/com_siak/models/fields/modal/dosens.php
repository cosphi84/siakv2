...
class JFormFieldModal_Dosens extends JFormField
{
    protected function getInput()
    {
        $value = (int) $this->value > 0 ? (int) $this->value : '';
        $modalId = 'Dosen_'.$this->id;
        ...
        JFactory::getDocument()->addScriptDeclaration('
			function jSelectDosen_'.$this->id."(id, title, catid, object, url, language) {
				window.processModalSelect('Dosen', '".$this->id."', id, title, catid, object, url, language);
			}
			");
        ...
        // url for the iframe
        $link = 'index.php?option=com_siak&amp;view=dosens&amp;layout=modal&amp;tmpl=component&amp;'.JSession::getFormToken().'=1';
        $urlSelect = $link.'&amp;function=jSelectDosen_'.$this->id;
