...
<form
    action="<?php echo JRoute::_('index.php?option=com_siak&view=paketmks'); ?>"
            ...
            <table class="table table-striped" id="classesList">
                <thead>
                    <tr>
                        ...
                        <th class="nowrap">
                            <?php echo JHtml::_('searchtools.sort', 'COM_SIAK_SEMESTER_FIELD_TITLE_LABEL', 'pk.semester', $listDirn, $listOrder); ?>
                        </th>
                        <th class="nowrap">
...
<?php echo $item->namaMK; ?></div>
                        ...
                        <td class="nowrap center hidden-phone">
                            <?php echo JHtml::_('jgrid.published', $item->published, $i, 'paketmks.', true, 'cb'); ?>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
